...
function Home() {
  ...
  const handleGenerate = (e: React.FormEvent) => {
    e.preventDefault();
    if (url) {
      navigate({ to: "/editor", search: { trackUrl: url, device } });
    }
  };

  return (
    <div className="flex flex-col overflow-x-clip">
      <main className="grow flex flex-col w-full max-w-7xl mx-auto px-margin-page py-16">
        {/* Hero Section */}
        <section className="flex flex-col items-center text-center mb-24 relative z-10">
          <div className="absolute inset-0 -z-10 bg-[radial-gradient(ellipse_at_top,var(--tw-gradient-stops))] from-primary/10 via-background to-background blur-3xl opacity-50 pointer-events-none"></div>
              ...
              >
                ...
                <div className="w-full md:w-auto relative">
                  <select
                    ...
                    className="w-full md:w-64 appearance-none bg-surface border border-white/10 rounded-xl py-4 pl-4 pr-10 text-on-surface font-body-md focus:border-primary focus:ring-1 focus:ring-primary outline-none cursor-pointer transition-all shadow-inner"
                  >
                ...
                <button
                  type="submit"
                  className="w-full md:w-auto bg-primary text-on-primary font-bold px-8 py-4 rounded-xl hover:bg-primary-fixed active:scale-95 transition-all flex items-center justify-center gap-2 whitespace-nowrap shadow-[0_4px_20px_rgba(83,224,118,0.3)] hover:shadow-[0_4px_30px_rgba(83,224,118,0.5)]"
                >
        ...
        <section className="mb-24 animate-in fade-in duration-1000 delay-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[350px]">
            ...
            <div className="bg-surface-container rounded-2xl overflow-hidden relative group border border-white/5">
              ...
              <div className="absolute inset-0 bg-linear-to-t from-black/90 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
